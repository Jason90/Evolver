        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParLevel = table.Column<decimal>(type: "TEXT", nullable: false),
                    ReorderPoint = table.Column<decimal>(type: "TEXT", nullable: false),
                    ReorderNeeded = table.Column<string>(type: "TEXT", nullable: false),
                    GapToPar = table.Column<decimal>(type: "TEXT", nullable: false),
                    TenantId = table.Column<int>(type: "INTEGER", nullable: false),
                    OrgId = table.Column<int>(type: "INTEGER", nullable: false),
                    IsDeleted = table.Column<bool>(type: "INTEGER", nullable: false),
                    CreateBy = table.Column<int>(type: "INTEGER", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MarketInventorySnapshots", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductId = table.Column<long>(type: "INTEGER", nullable: false),
                    PlannedOrders = table.Column<decimal>(type: "TEXT", nullable: false),
                    ...
                    MenuAction = table.Column<string>(type: "TEXT", nullable: false),
                    TenantId = table.Column<int>(type: "INTEGER", nullable: false),
                    OrgId = table.Column<int>(type: "INTEGER", nullable: false),
                    IsDeleted = table.Column<bool>(type: "INTEGER", nullable: false),
                    CreateBy = table.Column<int>(type: "INTEGER", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MenuIntelligenceRecords", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UnitPrice = table.Column<decimal>(type: "TEXT", nullable: false),
                    SalesValue = table.Column<decimal>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MarketInventorySnapshots_MarketId",
                table: "MarketInventorySnapshots",
                column: "MarketId");

            migrationBuilder.CreateIndex(
                name: "IX_MarketInventorySnapshots_ProductId",
                table: "MarketInventorySnapshots",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_MarketInventorySnapshots_TenantId_MarketId_ProductId_AsOfDate",
                table: "MarketInventorySnapshots",
                columns: new[] { "TenantId", "MarketId", "ProductId", "AsOfDate" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Markets_TenantId_Name",
                table: "Markets",
                columns: new[] { "TenantId", "Name" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_MenuIntelligenceRecords_MarketId",
                table: "MenuIntelligenceRecords",
                column: "MarketId");

            migrationBuilder.CreateIndex(
                name: "IX_MenuIntelligenceRecords_ProductId",
                table: "MenuIntelligenceRecords",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_MenuIntelligenceRecords_TenantId_MarketId_AsOfDate_Rank",
                table: "MenuIntelligenceRecords",
                columns: new[] { "TenantId", "MarketId", "AsOfDate", "Rank" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Organizations_TenantId_ParentId_Name",
                table: "Organizations",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Permissions_TenantId_OrgId_Code",
                table: "Permissions",
                columns: new[] { "TenantId", "OrgId", "Code" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Permissions_TenantId_OrgId_ParentId_Name",
                table: "Permissions",
                columns: new[] { "TenantId", "OrgId", "ParentId", "Name" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RolePermissions_TenantId_OrgId_RoleId_PermissionId",
                table: "RolePermissions",
                columns: new[] { "TenantId", "OrgId", "RoleId", "PermissionId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SalesEntries_MarketId",
                table: "SalesEntries",
                column: "MarketId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalesEntries_TenantId_MarketId_Date_ProductId",
                table: "SalesEntries",
                columns: new[] { "TenantId", "MarketId", "Date", "ProductId" });
